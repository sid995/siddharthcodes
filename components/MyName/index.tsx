  ...
  return (
    <div className="flex flex-col justify-center px-4 sm:px-0 py-32 sm:py-52 w-full sm:w-[500px] md:w-[700px] lg:w-[900px] mx-auto">
      ...
      <h3 className="text-gray-400 font-Header text-sm md:text-lg sm:text-md mt-10 tracking-wider">
        ...
        with 5 years of experience, currently pursuing a{" "}
        <span className="text-AAsecondary">
          masters degree in Computer Science at NJIT
        </span>
        . I possess strong problem-solving skills and specialize in crafting
        exceptional digital experiences. My expertise spans both{" "}
        <span className="text-AAsecondary">frontend</span> and{" "}
        <span className="text-AAsecondary">backend development</span>, with
        proficiency in{" "}
        <span className="text-AAsecondary">
          TypeScript, React, Next.js, TailwindCSS, Python, Go
        </span>
        , and <span className="text-AAsecondary">PostgreSQL</span>. I am also
        skilled in{" "}
        <span className="text-AAsecondary">
          Machine Learning, Deep Learning
        </span>
        , and <span className="text-AAsecondary">PyTorch</span>. My interests
        lie in the Machine Learning space, and I am{" "}
        <span className="text-AAsecondary">actively</span> looking for{" "}
        <span className="text-AAsecondary">internships</span> in{" "}
        <span className="text-AAsecondary">
