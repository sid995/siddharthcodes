    ...
    >
      <div className="flex flex-row items-center">
        ...
        <div className="flex flex-row space-x-2 items-center">
          ...
          <span className="text-sm sm:text-base font-sans text-AAsecondary">
            What&apos;s Next?
          </span>
        </div>
      </div>
      <span className="text-gray-200 text-xl md:text-3xl sm:text-4xl font-bold tracking-wider opacity-85">
        Get In Touch
      </span>
